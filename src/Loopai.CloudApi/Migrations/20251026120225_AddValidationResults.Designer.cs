...
namespace Loopai.CloudApi.Migrations
{
    ...
    [Migration("20251026120225_AddValidationResults")]
    partial class AddValidationResults
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Loopai.Core.Models.ValidationResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ExecutionId")
                        .HasColumnType("uniqueidentifier")
                        .HasAnnotation("Relational:JsonPropertyName", "execution_id");
                    ...
                    b.Property<DateTime>("ValidatedAt")
                        .HasColumnType("datetime2")
                        .HasAnnotation("Relational:JsonPropertyName", "validated_at");

                    b.Property<string>("ValidationMethod")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasAnnotation("Relational:JsonPropertyName", "validation_method");

                    b.Property<double>("ValidationScore")
                        .HasPrecision(5, 4)
                        .HasColumnType("float(5)")
                        .HasAnnotation("Relational:JsonPropertyName", "validation_score");

                    b.HasKey("Id");

                    b.HasIndex("ExecutionId");

                    b.HasIndex("ProgramId", "ValidatedAt");

                    b.HasIndex("TaskId", "ValidatedAt");

                    b.HasIndex("ProgramId", "IsValid", "ValidatedAt");
